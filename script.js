...
// ---------------------------Password on conditionText editable --------------------
var password = document.getElementById("conditionText");
...
const applySelectedTheme = () => {
    document.documentElement.style.setProperty('--bg-color-dark', '#1a1a1a');
    document.documentElement.style.setProperty('--accentLightTint-dark', '#333333');
    document.documentElement.style.setProperty('--darkerColor-dark', '#000000');
    document.documentElement.style.setProperty('--darkColor-dark', '#333333');
    document.documentElement.style.setProperty('--textColorDark-dark', '#ffffff');

    // Additional code for dark theme
    document.documentElement.style.setProperty('--bg-color-light', '#ffffff');
    document.documentElement.style.setProperty('--accentLightTint-light', '#f2f2f2');
    document.documentElement.style.setProperty('--darkerColor-light', '#e6e6e6');
    document.documentElement.style.setProperty('--darkColor-light', '#f2f2f2');
};
